...
document.addEventListener("DOMContentLoaded", () => {  
  ...
  if(document.body.classList.contains("dark-mode")) {
      ...
      image.setAttribute("src", "src/images/self1.png");
  }
  else{
    image.setAttribute("src", "src/images/self-image-blue.png");
  }
  ...
  themeToggleButton.addEventListener("click", () => {
      ...
      const image = document.getElementById("Self-Image");
      image.setAttribute("src", !document.body.classList.contains("dark-mode") ? "src/images/self-image-blue.png" : "src/images/self1.png");
...
document.addEventListener("click", (event) => {
  if (sidebar.classList.contains("sidebar--open") && !sidebar.contains(event.target) && !openSidebarBtn.contains(event.target)) {
      toggleNav();
  }
});
...
function handleSwipe() {
    if (touchEndX - touchStartX > 100 && !sidebar.classList.contains("sidebar--open")) {
        // Swiped right
        toggleNav();
    } else if (touchStartX - touchEndX > 100 && sidebar.classList.contains("sidebar--open")) {
...
const skills = [
    ...
    "Top 1% in ISC Examination",
    "Blind Coding Competition Winner",
...
function mailToLink() {
    ...
    var mailtoLink = `mailto:mdyasirkhan2003@gmail.com?subject=Message from ${name}&body=Name: ${name}%0AEmail: ${email}%0AMessage: ${message}`;
